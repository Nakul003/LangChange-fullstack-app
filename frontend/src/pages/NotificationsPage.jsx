...
const NotificationsPage = () => {
  ...
  const { mutate: acceptfriendRequestsMutation, isPending } = useMutation({
                            ...
                            <div key={request._id} className='card bg-base-200 shadow-sm hover:shadow-md transition-shadow'>
                              <div className='card-body p-4'>
                                <div className='flex items-center justify-between'>
                                  ...
                                  <button className='btn btn-primary btn-sm' onClick={() => acceptfriendRequestsMutation(request._id)} disabled={isPending}>
                                    Accept
                                  </button>
                                </div>
                              </div>
